...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (hasGsap) {
    ...
    heroTl
      ...
      .from('.tron-menu-deck', { y: 40, opacity: 0, scale: 0.95, duration: 1.2 }, '-=0.6')
      .from('.hero-title .line', { y: 60, opacity: 0, stagger: 0.15 }, '-=0.8')
      .from('.tron-sub-card', { opacity: 0, y: 20, duration: 0.8 }, '-=0.8')
      .from('.btn-tron-primary, .btn-tron-outline', { opacity: 0, y: 20, stagger: 0.15, duration: 0.8 }, '-=0.6')
